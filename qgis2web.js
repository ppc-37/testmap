...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [518956.911605, 418507.545486, 530122.643976, 425925.491490], maxZoom: 28, minZoom: 13, projection: 'EPSG:2180'
    })
});

map.getView().fit([518956.911605, 418507.545486, 530122.643976, 425925.491490], map.getSize());
